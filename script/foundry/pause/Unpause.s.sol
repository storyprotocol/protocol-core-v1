...
contract Unpause is Script {
    ...
    // Run with Ledger HW wallet: forge script script/foundry/pause/unpause.s.sol --rpc-url https://mainnet.storyrpc.io/ --ledger --broadcast
    // Run with Trezor HW wallet: forge script script/foundry/pause/unpause.s.sol --rpc-url https://mainnet.storyrpc.io/ --trezor --broadcast
    function run() public {
        console2.log("Initiate unpausing");
        vm.startBroadcast();

        address[] memory contractsToUnpause = getPausableContracts();
