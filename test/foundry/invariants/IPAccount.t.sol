...
// contract IPAccountReplayHarness is BaseTest {
//     bytes public signature;
//     uint256 public value = 0;
//     bytes public data = abi.encodeWithSignature("lol()");
//     address public signer;
//     uint256 public deadline = block.timestamp + 100;
//     IPAccountImpl public ipAccount;
//     Recorder public recorder;
...
//         (address _signer, uint256 key) = makeAddrAndKey("signer");

//         signer = _signer;

//         vm.startPrank(address(_signer));
//         mockNFT.mintId(address(_signer), 300);
//         address _ipAccount = ipAssetRegistry.register(block.chainid, address(mockNFT), 300);
//         assertTrue(ipAssetRegistry.isRegistered(_ipAccount));
//         vm.stopPrank();
...
//     function executeWithSigReplay() external {
//         ipAccount.executeWithSig(address(recorder), value, data, signer, deadline, signature);
//     }
// }

// /// @notice Signature replay attack invariants for IPAccount
// contract IPAccountReplayInvariants is BaseTest {
//     IPAccountReplayHarness public harness;
//     Recorder public recorder;

//     function setUp() public override {
//         super.setUp();
//         harness = new IPAccountReplayHarness();
//         recorder = harness.recorder();
//         targetContract(address(harness));
//     }

//     function invariant_replay() public {
//         uint256 recorded = recorder.recorded();
//         assertEq(recorded, 1, "recorded");
//     }
// }
