...
contract TestRoyaltyPolicyLAP is BaseTest {
    ...
    function test_RoyaltyPolicyLAP_constructor() public {
        testRoyaltyPolicyLAP = new RoyaltyPolicyLAP(address(royaltyModule), address(disputeModule));
    ...
    function test_RoyaltyPolicyLAP_initialize_revert_ZeroAccessManager() public {
        address impl = address(new RoyaltyPolicyLAP(address(royaltyModule), address(disputeModule)));
